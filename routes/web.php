...
use App\Http\Controllers\ManageEnquiresController;
...
Route::get("/manageBooking/list",[ManageBookingController::class,'list'])->name('managebooking.list');
Route::post("/manageBooking/store",[ManageBookingController::class,'list'])->name('managebooking.store');



Route::get("/manageenquires",[ManageEnquiresController::class,'menquires'])->name('manageenquires');
Route::get("/manageenquires/form",[ManageEnquiresController::class,'create'])->name('manageenquires.form');
...
Route::get("/bus/form",[BusController::class,'create'])->name('bus.form');
Route::post("/bus/form/store",[LocationController::class,'store'])->name('bus.store');
