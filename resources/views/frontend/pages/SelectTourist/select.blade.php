                            ...
                            <div class="card-body">
                                <form action="" method="" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="address" rows="1" placeholder="Enter your address"></textarea>
                                    </div>

                                    <div class="form-group">
                                        <label for="roomNumber" class="font-weight-bold">Choose Room</label>
                                        <div class="input-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control border-0 bg-light" id="quantity"
