                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="" method="" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select name="chooseroom" required
                                            ...
                                            <option>If Quantity more than 2 and odd number then select this one.
                                            </option>
                                ...
                                <button type="submit" class="btn btn-primary btn-block">Submit & Move on for Payment</button>
