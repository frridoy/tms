   ...
   <div class="login-panel">
     <h2> Update Your Profile </h2>
        ...
        <div class="form-group">
            ...
            <input type="name" required value="{{$touristprofileval->name}}" class="form-control" id="email" name="name" placeholder="Enter name">
          </div>
       <div class="form-group">
         <label for="email">Email Address:</label>
         <input type="text" required value="{{$touristprofileval->email}}" class="form-control" id="email" name="email" placeholder="Enter email">
       </div>
       <div class="form-group">
