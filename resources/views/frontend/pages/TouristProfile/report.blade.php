    ...
    <body>
        <div id="printDiv">
            ...
            <div class="profile-container">
                ...
                <div class="left-column text-center m-0">
                    ...
                    <hr>
                    <h6>Pick Up Date: {{ $bookings->pickupdate }}</h6>
                    <hr>
                </div>
                ...
                <div class="right-column">
                    <div class="user-info">
                        ...
                        <hr>
                        <h6> Package Code: {{ $bookings->code }}</h6>
                        <hr>
                    ...
                    {{-- <button class="btn btn-info" onclick="printContent('printDiv')"> My Booking Report</button> --}}

                </div>

            </div>
            <a href="" class="btn btn-outline-info" onclick="printContent('printDiv')">My Report</a>
        </div>
    </body>
