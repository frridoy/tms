...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="viewport" content="width=<!-- About 1 - Bootstrap Brain Component -->
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    ...
                    <p class="lead fs-4 text-secondary mb-4">We help people build incredible brands and superior products.
                    ...
                    <div class="brand-feature">
                        <div class="d-flex">
                            ...
                            <div>
                                <h4 class="mb-3">Versatile Brand</h4>
                                <p class="text-secondary mb-0">We are crafting a digital method that subsists life across
                                    all mediums.</p>
                            </div>
                        </div>
                    </div>
